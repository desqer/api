defmodule Desqer.AppointmentController do
  ...
  Params example by professional:
  ...
  Success response `code 200` example for customer:
  ...
  Success response `code 200` example for professional:
